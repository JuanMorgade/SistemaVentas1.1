    ...
    public partial class frmClientes : Form
    {
        ...
        private void frmClientes_Load(object sender, EventArgs e)
        {
            ...
            foreach (Cliente item in lista)
            {
                ...
                item.Documento, item.NombreCompleto, item.Correo, item.Telefono,
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdCliente == 0)
            {
                ...
                txtdocumento.Text, txtnombre.Text, txtcorreoo.Text, txttelefono.Text,
        ...
        private void btnExcell_Click_1(object sender, EventArgs e)
        {
