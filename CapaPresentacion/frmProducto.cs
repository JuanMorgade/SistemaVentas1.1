    ...
    public partial class frmProducto : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Codigoo"].Value = txtcodigo.Text;
                    row.Cells["Nombree"].Value = txtnombre.Text;
                    row.Cells["Descripcionn"].Value = txtdescripcion.Text;
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtcodigo.Text = dgvdata.Rows[indice].Cells["Codigoo"].Value.ToString();
                    txtnombre.Text = dgvdata.Rows[indice].Cells["Nombree"].Value.ToString();
                    txtdescripcion.Text = dgvdata.Rows[indice].Cells["Descripcionn"].Value.ToString();
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("Reporte Productos_{0}.xlsx",DateTime.Now.ToString("ddMMyyyyHHmmss"));
